...
import { A as Slot, P as require_jsx_runtime, d as DialogContent, f as DialogDescription, h as DialogTitle, l as Dialog, m as DialogPortal, p as DialogOverlay, u as DialogClose } from "../_libs/@radix-ui/react-alert-dialog+[...].mjs";
...
import { _ as CirclePlus, c as Printer, f as LogOut, i as Settings, p as LayoutDashboard, t as X, u as PanelLeft } from "../_libs/lucide-react.mjs";
...
import { t as Route$4 } from "./edit._id-BPm0zePB.mjs";
import { t as Route$5 } from "./print-C9xmNQ2u.mjs";
import { t as Separator$1 } from "../_libs/radix-ui__react-separator.mjs";
import { a as TooltipTrigger$1, i as TooltipProvider$1, n as TooltipContent$1, r as TooltipPortal, t as Tooltip$1 } from "../_libs/radix-ui__react-tooltip.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/router-BM58Vzsm.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
function AppLogo({ className = "h-9 w-9" }) {
...
var styles_default = "/assets/styles-BSfhMU4Q.css";
...
var Separator = import_react.forwardRef(({ className, orientation = "horizontal", decorative = true, ...props }, ref) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Separator$1, {
	ref,
	decorative,
	orientation,
...
Separator.displayName = Separator$1.displayName;
var Sheet = Dialog;
...
function AppSidebar() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Sidebar, {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SidebarHeader, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(AppLogo, {}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: "flex flex-col group-data-[collapsible=icon]:hidden",
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
					className: "text-sm font-semibold leading-tight",
					children: "ShippingLabelsDashboard"
				})
			})]
...
var Route$3 = createRootRouteWithContext()({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "ShippingLabelsDashboard"
			},
			{
				property: "og:title",
				content: "ShippingLabelsDashboard"
...
function AuthGate() {
	...
	const logout = useMutation({
		mutationFn: async () => {
			if (!(await fetch(`${API_BASE_URL}/auth/logout`, {
				method: "POST",
				credentials: "include"
			})).ok) throw new Error("Logout failed");
		},
		onSuccess: async () => {
			await refetch();
			router.navigate({ to: "/" });
	...
	if (!data?.authenticated) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(LoginPage, { onLoggedIn: refetch });
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(AuthenticatedApp, {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SidebarProvider, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("header", {
				className: "no-print h-14 flex items-center gap-3 border-b bg-card px-4 sticky top-0 z-10",
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SidebarTrigger, {}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(AppLogo, { className: "h-8 w-8 shrink-0 md:hidden" }),
...
function LoginPage({ onLoggedIn }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		className: "min-h-screen bg-background px-4 py-8 flex items-center justify-center",
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Card, {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(CardHeader, {
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(AppLogo, { className: "h-10 w-10" }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(CardTitle, {
						className: "text-lg",
						children: "ShippingLabelsDashboard Login"
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						className: "text-sm text-muted-foreground",
						children: "Sign in to manage shipping labels."
					})] })]
				})
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
						...
						children: login.isPending ? "Signing in..." : "Login"
					})
				]
			}) })]
		})
...
var $$splitComponentImporter$2 = () => import("./routes-CHaNQLIr.mjs");
var Route$2 = createFileRoute("/")({
	head: () => ({ meta: [
		...
		{
			property: "og:title",
			content: "Dashboard — ShippingLabelsDashboard"
		},
		{
			property: "og:description",
			content: "All your shipping labels in one place."
		}
	] }),
	component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
var $$splitComponentImporter$1 = () => import("./create-OEwMMRQt.mjs");
var Route$1 = createFileRoute("/create")({
	head: () => ({ meta: [
		...
		{
			property: "og:title",
			content: "Create Label — ShippingLabelsDashboard"
		},
		{
			property: "og:description",
			content: "Add a new parcel label with receiver details, courier and tracking."
...
var $$splitComponentImporter = () => import("./settings-CWqPuFJL.mjs");
var Route = createFileRoute("/settings")({
	head: () => ({ meta: [
		...
		{
			property: "og:title",
			content: "Settings — Sender Profiles & Courier APIs"
		},
		{
			property: "og:description",
			content: "Manage return-address profiles and courier tracking API keys."
...
var rootRouteChildren = {
	...
	CreateRoute: Route$1.update({
		id: "/create",
		path: "/create",
		getParentRoute: () => Route$3
	}),
	PrintRoute: Route$5.update({
		id: "/print",
		path: "/print",
		getParentRoute: () => Route$3
	}),
